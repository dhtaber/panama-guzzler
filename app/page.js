    ...
    <div className="flex gap-2 justify-center mb-2 flex-wrap">
      ...
      {availableLetters.map(tile => (
        <button
          ...
          className="w-10 h-10 border border-gray-300 rounded-xl font-bold cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-200 hover:from-blue-200 hover:to-purple-300 transform hover:scale-105 active:scale-95"
        >
